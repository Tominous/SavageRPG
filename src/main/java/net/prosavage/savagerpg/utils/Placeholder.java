...
public class Placeholder {
    ...
    public String parsePlayerInfo(Player user, String string){
        PDCPlayer player = new PDCPlayer(user);
    ...
    public String parseEntityInfo(Entity entity,String string){
        ...
        Integer entityLevel = entity.getPersistentDataContainer().get(SNamespacedKey.getEntityLevel(), PersistentDataType.INTEGER);
        Double entityEXP = entity.getPersistentDataContainer().get(SNamespacedKey.getEntityExp(), PersistentDataType.DOUBLE);
        Double entityRecentDamage = entity.getPersistentDataContainer().get(SNamespacedKey.getEntityRecentDamage(), PersistentDataType.DOUBLE);
        Double entityHealth = entity.getPersistentDataContainer().get(SNamespacedKey.getEntityHealth(), PersistentDataType.DOUBLE);
        Double entityMaxHealth = entity.getPersistentDataContainer().get(SNamespacedKey.getEntityMaxHealth(), PersistentDataType.DOUBLE);
        String entityName = entity.getPersistentDataContainer().get(SNamespacedKey.getEntityName(), PersistentDataType.STRING);
        Double entityDistance = entity.getPersistentDataContainer().get(SNamespacedKey.getEntityDistance(), PersistentDataType.DOUBLE);
        Double entityDamage = entity.getPersistentDataContainer().get(SNamespacedKey.getEntityDamage(), PersistentDataType.DOUBLE);
        string = string.replace("{mob-level}", String.valueOf(entityLevel))
