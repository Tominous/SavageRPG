...
public class Armor {
    ...
    public ItemStack setItem(ItemStack item) {
        ...
        if (chanceOf) {
            ...
            meta.getPersistentDataContainer().set(SRNamespacedKey.getNamespacedKey_armor_type(), PersistentDataType.STRING, itemName);
            meta.getPersistentDataContainer().set(SRNamespacedKey.getNamespacedKey_armor_rarity(), PersistentDataType.STRING, rarity);
            meta.getPersistentDataContainer().set(SRNamespacedKey.getNamespacedKey_armor_class(), PersistentDataType.STRING, "null");
            meta.getPersistentDataContainer().set(SRNamespacedKey.getNamespacedKey_armor_level(), PersistentDataType.INTEGER, level);
            meta.getPersistentDataContainer().set(SRNamespacedKey.getNamespacedKey_armor_protection(), PersistentDataType.DOUBLE, protection);
            meta.getPersistentDataContainer().set(SRNamespacedKey.getNamespacedKey_armor_health(), PersistentDataType.DOUBLE, health);
            meta.getPersistentDataContainer().set(SRNamespacedKey.getNamespacedKey_armor_regen(), PersistentDataType.DOUBLE, regen);
            meta.getPersistentDataContainer().set(SRNamespacedKey.getNamespacedKey_armor_gem(), PersistentDataType.INTEGER, gem);
            meta.getPersistentDataContainer().set(SRNamespacedKey.getNamespacedKey_armor_have_gem(), PersistentDataType.STRING, String.valueOf(noGem));
    ...
    public ItemStack setLore(ItemStack item) {
        if (item.getType() != Material.AIR) {
            ...
            String itemName = meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_type(), PersistentDataType.STRING);
            String rarity = meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_rarity(), PersistentDataType.STRING);
            String classType = meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_class(), PersistentDataType.STRING);
            Integer level = meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_level(), PersistentDataType.INTEGER);
            Double protection = meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_protection(), PersistentDataType.DOUBLE);
            Double health = meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_health(), PersistentDataType.DOUBLE);
            Double regen = meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_regen(), PersistentDataType.DOUBLE);
            Integer gem = meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_gem(), PersistentDataType.INTEGER);
            String noGem = meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_have_gem(), PersistentDataType.STRING);
    ...
    public String getType(ItemStack item) {
        ...
        return Objects.requireNonNull(meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_type(), PersistentDataType.STRING));
    }
    ...
    public String getRarity(ItemStack item) {
        ...
        return Objects.requireNonNull(meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_rarity(), PersistentDataType.STRING));
    }
    ...
    public String getClass(ItemStack item) {
        ...
        return Objects.requireNonNull(meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_class(), PersistentDataType.STRING));
    }
    ...
    public int getLevel(ItemStack item) {
        ...
        return Objects.requireNonNull(meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_level(), PersistentDataType.INTEGER));
    }
    ...
    public double getProtection(ItemStack item) {
        ...
        return Objects.requireNonNull(meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_protection(), PersistentDataType.DOUBLE));
    }
    ...
    public double getHealth(ItemStack item) {
        ...
        return Objects.requireNonNull(meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_health(), PersistentDataType.DOUBLE));
    }
    ...
    public double getRegen(ItemStack item) {
        ...
        return Objects.requireNonNull(meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_regen(), PersistentDataType.DOUBLE));
    }
    ...
    public int getGem(ItemStack item) {
        ...
        return Objects.requireNonNull(meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_gem(), PersistentDataType.INTEGER));
    }
    ...
    public boolean haveGem(ItemStack item) {
        ...
        return Boolean.valueOf(Objects.requireNonNull(meta.getPersistentDataContainer().get(SRNamespacedKey.getNamespacedKey_armor_have_gem(), PersistentDataType.STRING)));
    }
}